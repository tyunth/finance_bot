...
1. Оцени нагрузку по календарю:
   - Мало событий (0-2) -> "День на чиле".
   - Средне (3-4) -> "Рабочий ритм".
   - Много (5+) -> "Сегодня жесть/мясо".
   - Если видишь, что с одним учеником подряд идет 2+ урока — отметь это ("Марафон с Али").
2. Оцени задачи:
   - Есть ли просроченные (>3 дней)?
   - Много ли срочных?
...
Просто пожелай удачи на конкретном экзамене (если есть) или терпения, если день загружен.
