...
3. СПИСОК ДЕЛ (Важно):
   - Сгруппируй задачи по приоритету.
   - ОБРАТИ ВНИМАНИЕ на поле "days_active".
   - Для старых задач (>3 дней) укажи в скобках возраст
   - Если больше 7 дней — ПОЖУРИ пользователя (саркастично), что он прокрастинирует.
   - Если задач нет — похвали.
