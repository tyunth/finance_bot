...
const ADMIN_ID = parseInt(process.env.MY_USER_ID); // Ваш ID для уведомлений

// Настройки уроков
const LESSON_PRICE = 4000;
// Добавил 'Тест' для проверки
const KEYWORDS = ['Никита', 'Али', 'Дима', 'Удаленка', 'Го', 'Пробный урок', 'Тест']; 
