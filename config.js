...
// Настройки уроков
const LESSON_PRICE = 5000;
const KEYWORDS = ['Никита', 'Али', 'Дима', 'Удаленка', 'Го', 'Пробный урок', 'Тест','Алина','дома', 'Арина', 'Матвей', 'Инкара', 'Максим', 'Леонид','Азат' ]; 
...
const STATE = {
    ...
    AWAITING_INTEREST_CORRECTION: 'AWAITING_INTEREST_CORRECTION',
	AWAITING_SHOPPING_ITEM: 'AWAITING_SHOPPING_ITEM',
	AWAITING_SHOPPING_EDIT: 'AWAITING_SHOPPING_EDIT'
};
